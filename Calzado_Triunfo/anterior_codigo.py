hacer exactamente lo mismo que hace este codigo, solo que en vez de utilizar df1, usar la API de odoo de esa instancia
...
df_unique = df_unique.loc[:, ['id','name', 'email', 'category_id/name', 'company_type']]
